...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.isPlanetaryIkBindToGlobal_checkBox = QtWidgets.QCheckBox(self.groupBox_4)
        self.isPlanetaryIkBindToGlobal_checkBox.setText("Split Hip Fk control from others.")
        self.isPlanetaryIkBindToGlobal_checkBox.setChecked(True)
        self.isPlanetaryIkBindToGlobal_checkBox.setObjectName("isPlanetaryIkBindToGlobal_checkBox")
        self.gridLayout_5.addWidget(self.isPlanetaryIkBindToGlobal_checkBox, 5, 0, 1, 1)
        self.isUpvectorAimToTip_checkBox = QtWidgets.QCheckBox(self.groupBox_4)
        self.isUpvectorAimToTip_checkBox.setText("Split Hip Fk control from others.")
        self.isUpvectorAimToTip_checkBox.setChecked(True)
        self.isUpvectorAimToTip_checkBox.setObjectName("isUpvectorAimToTip_checkBox")
        self.gridLayout_5.addWidget(self.isUpvectorAimToTip_checkBox, 5, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.isPlanetaryIkBindToGlobal_checkBox.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>If checked each controller is free from its parent xform.</p></body></html>", None, -1))
        self.isUpvectorAimToTip_checkBox.setToolTip(QtWidgets.QApplication.translate("Form", "<html><head/><body><p>If checked the upvector named length_ctl aim to ik[-1]_ctl_</p></body></html>", None, -1))
