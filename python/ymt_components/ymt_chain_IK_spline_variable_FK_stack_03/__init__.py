...
class Component(component.Main):
    ...
    def addObjectsChainIk(self, i, crv):
        ...
        ik_global_npo = addTransform(parent, self.getName("ik%s_global_npo" % i), global_t)
    ...
    def addAttributes(self):
        ...
        _classicChannelNames = self.options["classicChannelNames"]
        self.options["classicChannelNames"] = True
        ...
        self.sq_att = [self.addSetupParam("squash_%s" % i,
                                          ...
                                          1)
                       for i in range(self.divisions)]
        self.options["classicChannelNames"] = _classicChannelNames
